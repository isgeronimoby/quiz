...
function hideUnnecessaryElements(){
	if (currentPlatform == "desktop"){
		...
		$('.show-desktop').removeClass('hidden').addClass('shown');
		$('.show-mobile').removeClass('shown').addClass('hidden');
	} else {
		//show elements if mobile detected
		$('.show-mobile').removeClass('hidden').addClass('shown');
		$('.show-desktop').removeClass('shown').addClass('hidden');
	}
}
